...
export const nativeCallables: NativeCallable[] = [
    ...
    callable('Router', 'group', ['string $prefix', 'func $callback'], 'nil', 'Agrupa rutas bajo un prefijo.'),
    callable('Router', 'middleware', ['string $name', 'func $callback = nil'], 'nil', 'Aplica middleware a un grupo.'),
    ...
    callable('Response', 'stream', ['func $callback', 'string $mime = "text/event-stream"'], 'WebResponse', 'Crea una respuesta transmitida.'),
    ...
    callable('Cron', 'schedule', ['string $name', 'string $expression', 'func $callback'], 'nil', 'Programa una tarea cron.'),
    callable('Task', 'on_request', ['string $name', 'func $callback'], 'nil', 'Registra una tarea por petición.'),
